...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--batchSize', type=int, default=55, help='input batch size')
        ...
        self.parser.add_argument('--biased_sampling', type=int, default=-1, help='window id of the web display')
